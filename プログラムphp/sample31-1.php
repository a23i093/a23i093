...
<body>
<?php
print "<h1> sample31-1.php 作者 佐々木(a23i093)</h1>\n";
...
$query = "INSERT INTO tbl_hanbai(id, tokuisaki, code,hanbaisu) VALUES(2,'S商店', 'A5023', 150)";
$stmt = $pdo->prepare($query);
$stmt -> execute();
...
$query = "INSERT INTO tbl_hanbai(id, tokuisaki, code,hanbaisu) VALUES(5,'S商店', 'A5027', 160)";
$stmt = $pdo->prepare($query);
$stmt -> execute();

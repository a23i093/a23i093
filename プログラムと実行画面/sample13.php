...
print "<h1> sample13.php 佐々木　温(a23i093)</h1>\n"; 
...
print "<input type=\"submit\" valie=\"送信\"/> <br/>\n";
print "</form>\n"; 

if(isset($_POST["s0"])&&isset($_POST["s1"])&&isset($_POST["s2"])&&isset($_POST["s3"])&&isset($_POST["k0"])&&isset($_POST["k1"])&&isset($_POST["k2"])&&isset($_POST["k3"])){
